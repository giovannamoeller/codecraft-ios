...
struct SinglyLinkedListIntroductionView: View {
    let singlyLinkedListInformation = DataStructureInformation(
        ...
        analogies: [
            GridData(icon: "person.3", title: "Conga line", description: "Each person holds the next person's shoulders."),
            GridData(icon: "train.side.front.car", title: "Train cars", description: "Each car is connected to the next one."),
            GridData(icon: "text.book.closed", title: "Choose Your Adventure", description: "Each page points to the next part of the story."),
            GridData(icon: "link", title: "Treasure Hunt", description: "Each clue leads to the location of the next clue.")
        ],
        useCases: [
